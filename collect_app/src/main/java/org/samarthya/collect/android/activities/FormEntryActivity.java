...
import org.samarthya.collect.android.activities.ViewOnlyFormHierarchyActivity;
import org.samarthya.collect.android.analytics.AnalyticsEvents;
import org.samarthya.collect.android.application.Collect;
import org.samarthya.collect.android.audio.AMRAppender;
import org.samarthya.collect.android.audio.AudioControllerView;
import org.samarthya.collect.android.audio.M4AAppender;
import org.samarthya.collect.android.backgroundwork.InstanceSubmitScheduler;
import org.samarthya.collect.android.dao.helpers.InstancesDaoHelper;
import org.samarthya.collect.android.events.ReadPhoneStatePermissionRxEvent;
...
import org.samarthya.collect.android.formentry.FormEndView;
import org.samarthya.collect.android.formentry.FormEntryMenuDelegate;
...
import org.samarthya.collect.android.formentry.FormIndexAnimationHandler.Direction;
import org.samarthya.collect.android.formentry.FormLoadingDialogFragment;
...
import org.samarthya.collect.android.formentry.RecordingHandler;
...
import org.samarthya.collect.android.formentry.audit.AuditUtils;
import org.samarthya.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.samarthya.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.samarthya.collect.android.formentry.audit.IdentityPromptViewModel;
...
import org.samarthya.collect.android.formentry.loading.FormInstanceFileCreator;
import org.samarthya.collect.android.formentry.repeats.AddRepeatDialog;
import org.samarthya.collect.android.formentry.repeats.DeleteRepeatDialogFragment;
...
import org.samarthya.collect.android.formentry.saving.SaveAnswerFileProgressDialogFragment;
import org.samarthya.collect.android.formentry.saving.SaveFormProgressDialogFragment;
import org.samarthya.collect.android.fragments.MediaLoadingFragment;
...
import org.samarthya.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
...
import org.samarthya.collect.android.fragments.dialogs.RankingWidgetDialog;
...
import org.samarthya.collect.android.javarosawrapper.FormController.FailedConstraint;
...
import org.samarthya.collect.android.listeners.SavePointListener;
import org.samarthya.collect.android.listeners.SwipeHandler;
import org.samarthya.collect.android.listeners.WidgetValueChangedListener;
import org.samarthya.collect.android.logic.ImmutableDisplayableQuestion;
...
import org.samarthya.collect.android.tasks.SavePointTask;
...
import org.samarthya.collect.android.utilities.DestroyableLifecyleOwner;
...
import org.samarthya.collect.android.utilities.SnackbarUtils;
...
import org.samarthya.collect.android.widgets.utilities.FormControllerWaitingForDataRegistry;
import org.samarthya.collect.android.widgets.utilities.InternalRecordingRequester;
import org.samarthya.collect.android.widgets.utilities.ViewModelAudioPlayer;
...
import org.samarthya.collect.audioclips.AudioClipViewModel;
...
import static org.samarthya.collect.android.analytics.AnalyticsEvents.OPEN_MAP_KIT_RESPONSE;
import static org.samarthya.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.samarthya.collect.android.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static org.samarthya.collect.android.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static org.samarthya.collect.android.preferences.keys.ProtectedProjectKeys.KEY_MOVING_BACKWARDS;
import static org.samarthya.collect.android.preferences.keys.ProjectKeys.KEY_COMPLETED_DEFAULT;
import static org.samarthya.collect.android.preferences.keys.ProjectKeys.KEY_NAVIGATION;
import static org.samarthya.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.samarthya.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.samarthya.collect.android.utilities.DialogUtils.getDialog;
import static org.samarthya.collect.android.utilities.DialogUtils.showIfNotShowing;
import static org.samarthya.collect.android.utilities.ToastUtils.showLongToast;
import static org.samarthya.collect.android.utilities.ToastUtils.showShortToast;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        submitButton = findViewById(R.id.form_submit_button);
    ...
    private void updateNavigationButtonVisibility() {
        ...
        try {
            if(formController.getFormTitle().contains("School")){
                if (formController.getQuestionPrompts()[formController.getQuestionPrompts().length - 1].getQuestionText().contains("Feedback")) {
                    isLastPage = true;
                }
            }else {
                if (formController.getQuestionPrompts()[formController.getQuestionPrompts().length - 1].getQuestionText().contains("Image")) {
                    isLastPage = true;
                }
            }
        }catch(Exception e){
        ...
        if(!isLastPage){
            ...
            submitButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    formSaveViewModel.saveForm(getIntent().getData(), true, formController.getFormTitle(), true);
                }
            });
        }
    }
        ...
        if (formLoaderTask != null) {
            ...
            if (formController == null
                ...
                if (fec != null) {
                    ...
                    startActivity(new Intent(this, org.samarthya.collect.android.activities.MainMenuActivity.class));
                }
            }
        } else {
            if (formController == null) {
