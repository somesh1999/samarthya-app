...
import org.samarthya.collect.android.activities.BaseGeoMapActivity;
...
import org.samarthya.collect.android.activities.viewmodels.FormMapViewModel.MappableFormInstance;
...
public class FormMapActivity extends BaseGeoMapActivity {
    ...
    public void onFeatureClicked(int featureId) {
        ...
        if (!isSummaryForGivenSubmissionDisplayed(featureId)) {
            ...
            MappableFormInstance mappableFormInstance = instancesByFeatureId.get(featureId);
