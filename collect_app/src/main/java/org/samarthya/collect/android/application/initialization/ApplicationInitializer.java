...
import org.samarthya.collect.android.application.initialization.CrashReportingTree;
import org.samarthya.collect.android.application.initialization.UserPropertiesInitializer;
...
import org.samarthya.collect.android.logic.actions.setgeopoint.CollectSetGeopointActionHandler;
...
public class ApplicationInitializer {
    ...
    private void initializeJavaRosa() {
        ...
        PrototypeManager.registerPrototype("org.samarthya.collect.android.logic.actions.setgeopoint.CollectSetGeopointAction");
    ...
    private void initializeLogging() {
        if (BuildConfig.BUILD_TYPE.equals("odkCollectRelease")) {
            Timber.plant(new org.samarthya.collect.android.application.initialization.CrashReportingTree(analytics));
        } else {
