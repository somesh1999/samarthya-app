...
import static org.samarthya.collect.android.backgroundwork.BackgroundWorkUtils.getPeriodInMilliseconds;
...
public class FormUpdateAndInstanceSubmitScheduler implements FormUpdateScheduler, InstanceSubmitScheduler {
    ...
    private void scheduleAutoUpdate(long periodInMilliseconds, String projectId) {
        ...
        inputData.put(org.samarthya.collect.android.backgroundwork.AutoUpdateTaskSpec.DATA_PROJECT_ID, projectId);
    ...
    private void scheduleMatchExactly(long periodInMilliseconds, String projectId) {
        HashMap<String, String> inputData = new HashMap<>();
        inputData.put(org.samarthya.collect.android.backgroundwork.SyncFormsTaskSpec.DATA_PROJECT_ID, projectId);
    ...
    public void scheduleSubmit(String projectId) {
        HashMap<String, String> inputData = new HashMap<>();
        inputData.put(org.samarthya.collect.android.backgroundwork.AutoSendTaskSpec.DATA_PROJECT_ID, projectId);
