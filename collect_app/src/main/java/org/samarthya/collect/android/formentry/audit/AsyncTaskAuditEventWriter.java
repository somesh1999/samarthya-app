...
import org.samarthya.collect.android.formentry.audit.AuditEventSaveTask;
...
public class AsyncTaskAuditEventWriter implements AuditEventLogger.AuditEventWriter {
    ...
    @Override
    public void writeEvents(List<org.samarthya.collect.android.formentry.audit.AuditEvent> auditEvents) {
        org.samarthya.collect.android.formentry.audit.AuditEvent[] auditEventArray = auditEvents.toArray(new AuditEvent[0]);
