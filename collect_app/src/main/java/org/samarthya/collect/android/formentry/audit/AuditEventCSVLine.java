...
import static org.samarthya.collect.android.utilities.CSVUtils.getEscapedValueForCsv;
...
public class AuditEventCSVLine {
    ...
    public static String toCSVLine(org.samarthya.collect.android.formentry.audit.AuditEvent auditEvent, boolean isTrackingLocationsEnabled, boolean isTrackingChangesEnabled, boolean isTrackingChangesReasonEnabled) {
