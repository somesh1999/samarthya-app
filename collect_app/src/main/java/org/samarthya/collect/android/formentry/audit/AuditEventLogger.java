...
public class AuditEventLogger {
    ...
    private ArrayList<org.samarthya.collect.android.formentry.audit.AuditEvent> auditEvents = new ArrayList<>();
    private long surveyOpenTime;
    private long surveyOpenElapsedTime;

    private final org.samarthya.collect.android.formentry.audit.AuditConfig auditConfig;
    ...
    public void logEvent(org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType eventType, boolean writeImmediatelyToDisk, long currentTime) {
     ...
     * Log a new event
     */
    public void logEvent(org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType eventType, FormIndex formIndex,
        ...
        org.samarthya.collect.android.formentry.audit.AuditEvent newAuditEvent = new org.samarthya.collect.android.formentry.audit.AuditEvent(
                getEventTime(),
                eventType,
                formIndex,
                questionAnswer,
         ...
         */
        if (eventType == org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType.FORM_EXIT) {
            finalizeEvents();
        }
    ...
    private void addLocationCoordinatesToAuditEvent(org.samarthya.collect.android.formentry.audit.AuditEvent auditEvent, long currentTime) {
    ...
    private void addNewValueToQuestionAuditEvent(org.samarthya.collect.android.formentry.audit.AuditEvent aev, FormController formController) {
    ...
    boolean isDuplicateOfLastLocationEvent(org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType eventType) {
     ...
     */
    private boolean isDuplicatedIntervalEvent(org.samarthya.collect.android.formentry.audit.AuditEvent newAuditEvent) {
        if (newAuditEvent.isIntervalAuditEventType()) {
            for (org.samarthya.collect.android.formentry.audit.AuditEvent aev : auditEvents) {
    ...
    private void finalizeEvents() {
        ...
        ArrayList<org.samarthya.collect.android.formentry.audit.AuditEvent> filteredAuditEvents = new ArrayList<>();
        for (org.samarthya.collect.android.formentry.audit.AuditEvent aev : auditEvents) {
            if (aev.isIntervalAuditEventType()) {
    ...
    private void setIntervalEventFinalParameters(org.samarthya.collect.android.formentry.audit.AuditEvent aev, long end, FormController formController) {
        ...
        // Set answers
        if (aev.getAuditEventType().equals(org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType.QUESTION) && formController != null) {
     ...
     */
    private boolean shouldBeIgnored(org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType eventType) {
    ...
    */
    private boolean shouldEventBeLogged(org.samarthya.collect.android.formentry.audit.AuditEvent aev) {
        if (aev.getAuditEventType().equals(org.samarthya.collect.android.formentry.audit.AuditEvent.AuditEventType.QUESTION) && formController != null) {
