...
import org.samarthya.collect.android.logic.actions.setgeopoint.CollectSetGeopointAction;
...
public class BackgroundLocationManager implements LocationClient.LocationClientListener, LocationListener {
    ...
    @NonNull
    private org.samarthya.collect.android.formentry.backgroundlocation.BackgroundLocationHelper helper;
