...
import static org.samarthya.collect.android.tasks.SaveFormToDisk.SAVED;
import static org.samarthya.collect.android.tasks.SaveFormToDisk.SAVED_AND_EXIT;
import static org.samarthya.collect.android.utilities.StringUtils.isBlank;
...
public class FormSaveViewModel extends ViewModel implements ProgressDialogFragment.Cancellable, RequiresFormController, QuestionMediaManager {
    ...
    private final org.samarthya.collect.android.formentry.saving.FormSaver formSaver;
    ...
    public FormSaveViewModel(SavedStateHandle stateHandle, Clock clock, org.samarthya.collect.android.formentry.saving.FormSaver formSaver, MediaUtils mediaUtils, Analytics analytics, Scheduler scheduler, AudioRecorder audioRecorder, CurrentProjectProvider currentProjectProvider) {
