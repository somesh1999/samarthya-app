...
public class ServerFormsDetailsFetcher {
    ...
    private final org.samarthya.collect.android.formmanagement.DiskFormsSynchronizer diskFormsSynchronizer;
    ...
    public List<org.samarthya.collect.android.formmanagement.ServerFormDetails> fetchFormDetails() throws FormSourceException {
        diskFormsSynchronizer.synchronize();

        List<FormListItem> formListItems = formSource.fetchFormList();
        List<org.samarthya.collect.android.formmanagement.ServerFormDetails> serverFormDetailsList = new ArrayList<>();
        ...
        for (FormListItem listItem : formListItems) {
            ...
            org.samarthya.collect.android.formmanagement.ServerFormDetails serverFormDetails = new ServerFormDetails(
                    listItem.getName(),
