...
import org.samarthya.collect.android.fragments.FormListFragment;
...
import org.samarthya.collect.android.listeners.DeleteFormsListener;
...
import org.samarthya.collect.android.tasks.DeleteFormsTask;
...
public class BlankFormListFragment extends FormListFragment implements DiskSyncListener,
    ...
    public BlankFormListFragment(String formFormat){
    ...
    protected CursorLoader getCursorLoader() {
        return new CursorLoaderFactory(currentProjectProvider).getFormsCursorLoader(getFilterText(), getSortingOrder(), false, formFormat);
    }
