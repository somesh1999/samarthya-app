...
import org.samarthya.collect.android.adapters.InstanceListCursorAdapter;
...
import org.samarthya.collect.android.fragments.InstanceListFragment;
import org.samarthya.collect.android.injection.DaggerUtils;
import org.samarthya.collect.android.listeners.DeleteInstancesListener;
import org.samarthya.collect.android.projects.CurrentProjectProvider;
import org.samarthya.collect.android.tasks.DeleteInstancesTask;
...
public class SavedFormListFragment extends InstanceListFragment implements DeleteInstancesListener, View.OnClickListener {
    ...
    public SavedFormListFragment(String formFormat){
    ...
    protected CursorLoader getCursorLoader() {
        return new CursorLoaderFactory(currentProjectProvider).createSavedInstancesCursorLoader(getFilterText(), getSortingOrder(), formFormat);
    }
