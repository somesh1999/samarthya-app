...
import static org.samarthya.collect.android.utilities.InstanceUploaderUtils.DEFAULT_SUCCESSFUL_TEXT;
...
public class InstanceGoogleSheetsUploaderTask extends InstanceUploaderTask {
    ...
    private final org.samarthya.collect.android.gdrive.GoogleApiProvider googleApiProvider;
    ...
    protected Outcome doInBackground(Long... instanceIdsToUpload) {
        ...
        org.samarthya.collect.android.gdrive.InstanceGoogleSheetsUploader uploader = new InstanceGoogleSheetsUploader(googleApiProvider.getDriveApi(account), googleApiProvider.getSheetsApi(account));
