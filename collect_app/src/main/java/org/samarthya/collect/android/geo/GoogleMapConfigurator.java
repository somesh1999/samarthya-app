...
class GoogleMapConfigurator implements MapConfigurator {
    ...
    @Override public MapFragment createMapFragment(Context context) {
        return new org.samarthya.collect.android.geo.GoogleMapFragment();
    }
    ...
    @Override public Bundle buildConfig(Settings prefs) {
        ...
        config.putInt(org.samarthya.collect.android.geo.GoogleMapFragment.KEY_MAP_TYPE,
    ...
    @Override public boolean supportsLayer(File file) {
        ...
        return org.samarthya.collect.android.geo.MbtilesFile.readLayerType(file) == LayerType.RASTER;
    }
