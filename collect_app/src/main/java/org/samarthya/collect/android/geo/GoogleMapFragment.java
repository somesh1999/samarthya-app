...
import org.samarthya.collect.android.geo.GoogleMapsMapBoxOfflineTileProvider;
...
public class GoogleMapFragment extends SupportMapFragment implements
    ...
    org.samarthya.collect.android.geo.MapPoint getCenter() {
        ...
        return new org.samarthya.collect.android.geo.MapPoint(target.latitude, target.longitude);
    }
    ...
    org.samarthya.collect.android.geo.MapPoint fromLatLng(@NonNull LatLng latLng) {
        return new org.samarthya.collect.android.geo.MapPoint(latLng.latitude, latLng.longitude);
    }
    ...
    org.samarthya.collect.android.geo.MapPoint fromMarker(@NonNull Marker marker) {
        ...
        return new org.samarthya.collect.android.geo.MapPoint(position.latitude, position.longitude, alt, sd);
    }
    ...
    private Marker createMarker(GoogleMap map, org.samarthya.collect.android.geo.MapPoint point, boolean draggable, @IconAnchor String iconAnchor) {
    ...
    private class MarkerFeature implements MapFeature {
        ...
        MarkerFeature(GoogleMap map, org.samarthya.collect.android.geo.MapPoint point, boolean draggable, @IconAnchor String iconAnchor) {
    ...
    private class PolyFeature implements MapFeature {
        ...
        PolyFeature(GoogleMap map, Iterable<org.samarthya.collect.android.geo.MapPoint> points, boolean closedPolygon) {
            this.map = map;
