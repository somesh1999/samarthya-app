...
public interface MapFragment {
    org.samarthya.collect.android.geo.MapPoint INITIAL_CENTER = new org.samarthya.collect.android.geo.MapPoint(0, -30);
     ...
     */
    void setCenter(@Nullable org.samarthya.collect.android.geo.MapPoint center, boolean animate);
     ...
     */
    void zoomToPoint(@Nullable org.samarthya.collect.android.geo.MapPoint center, boolean animate);
     ...
     */
    void zoomToPoint(@Nullable org.samarthya.collect.android.geo.MapPoint center, double zoom, boolean animate);
     ...
     */
    void zoomToBoundingBox(Iterable<org.samarthya.collect.android.geo.MapPoint> points, double scaleFactor, boolean animate);
     ...
     */
    int addMarker(org.samarthya.collect.android.geo.MapPoint point, boolean draggable, @IconAnchor String iconAnchor);
     ...
     * Returns a positive integer, the featureId for the newly added shape.
     */
    int addDraggablePoly(@NonNull Iterable<org.samarthya.collect.android.geo.MapPoint> points, boolean closedPolygon);

    /** Appends a vertex to the polyline or polygon specified by featureId. */
    void appendPointToPoly(int featureId, @NonNull org.samarthya.collect.android.geo.MapPoint point);
     ...
     */
    @NonNull List<org.samarthya.collect.android.geo.MapPoint> getPolyPoints(int featureId);
