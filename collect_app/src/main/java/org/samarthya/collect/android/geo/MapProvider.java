...
import org.samarthya.collect.android.geo.GoogleMapConfigurator;
import org.samarthya.collect.android.geo.GoogleMapConfigurator.GoogleMapTypeOption;
import org.samarthya.collect.android.geo.MapConfigurator;
import org.samarthya.collect.android.geo.MapFragment;
import org.samarthya.collect.android.geo.MapboxMapConfigurator;
import org.samarthya.collect.android.geo.MapboxMapConfigurator.MapboxUrlOption;
import org.samarthya.collect.android.geo.OsmDroidMapConfigurator;
import org.samarthya.collect.android.geo.OsmDroidMapConfigurator.WmsOption;
...
import static org.samarthya.collect.android.preferences.keys.ProjectKeys.BASEMAP_SOURCE_OSM;
import static org.samarthya.collect.android.preferences.keys.ProjectKeys.BASEMAP_SOURCE_STAMEN;
...
public class MapProvider {
    ...
    private final Map<org.samarthya.collect.android.geo.MapFragment, Settings.OnSettingChangeListener>
        listenersByMap = new WeakHashMap<>();

    /** Keeps track of the configurator associated with a given MapFragment. */
    private final Map<org.samarthya.collect.android.geo.MapFragment, MapConfigurator>
    ...
    public org.samarthya.collect.android.geo.MapFragment createMapFragment(Context context) {
        MapConfigurator cftor = getConfigurator();
        org.samarthya.collect.android.geo.MapFragment map = cftor.createMapFragment(context);
        if (map != null) {
    ...
    void onMapFragmentStart(org.samarthya.collect.android.geo.MapFragment map) {
