...
import org.samarthya.collect.android.geo.OsmMBTileProvider;
...
public class OsmDroidMapFragment extends Fragment implements MapFragment,
    ...
    private org.samarthya.collect.android.geo.WebMapService webMapService;
    ...
    @Override public void applyConfig(Bundle config) {
        webMapService = (org.samarthya.collect.android.geo.WebMapService) config.getSerializable(KEY_WEB_MAP_SERVICE);
    ...
    @Override public void onLocationChanged(Location location) {
        ...
        if (gpsLocationListener != null) {
            org.samarthya.collect.android.geo.MapPoint point = fromLocation(myLocationOverlay);
            if (point != null) {
    ...
    org.samarthya.collect.android.geo.MapPoint fromLocation(@NonNull MyLocationNewOverlay overlay) {
        GeoPoint geoPoint = overlay.getMyLocation();
        if (geoPoint == null) {
            return null;
        }
        return new org.samarthya.collect.android.geo.MapPoint(
    ...
    org.samarthya.collect.android.geo.MapPoint fromGeoPoint(@NonNull IGeoPoint geoPoint) {
        return new org.samarthya.collect.android.geo.MapPoint(geoPoint.getLatitude(), geoPoint.getLongitude());
    }

    private static @NonNull
    org.samarthya.collect.android.geo.MapPoint fromGeoPoint(@NonNull GeoPoint geoPoint) {
        return new org.samarthya.collect.android.geo.MapPoint(geoPoint.getLatitude(), geoPoint.getLongitude(), geoPoint.getAltitude());
    }

    private static @NonNull
    org.samarthya.collect.android.geo.MapPoint fromMarker(@NonNull Marker marker) {
    ...
    private static @NonNull GeoPoint toGeoPoint(@NonNull org.samarthya.collect.android.geo.MapPoint point) {
    ...
    private void loadReferenceOverlay() {
        ...
        if (referenceLayerFile != null) {
            org.samarthya.collect.android.geo.OsmMBTileProvider mbprovider = new OsmMBTileProvider(this, referenceLayerFile);
    ...
    private Marker createMarker(MapView map, org.samarthya.collect.android.geo.MapPoint point, MapFeature feature, @IconAnchor String iconAnchor) {
    ...
    private class MarkerFeature implements MapFeature {
        ...
        MarkerFeature(MapView map, org.samarthya.collect.android.geo.MapPoint point, boolean draggable, @IconAnchor String iconAnchor) {
            this.map = map;
    ...
    private class PolyFeature implements MapFeature {
        ...
        PolyFeature(MapView map, Iterable<org.samarthya.collect.android.geo.MapPoint> points, boolean closedPolygon) {
            this.map = map;
        ...
        public List<org.samarthya.collect.android.geo.MapPoint> getPoints() {
            List<org.samarthya.collect.android.geo.MapPoint> points = new ArrayList<>();
            for (Marker marker : markers) {
