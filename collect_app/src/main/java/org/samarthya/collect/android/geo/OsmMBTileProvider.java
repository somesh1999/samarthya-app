...
import org.samarthya.collect.android.geo.OsmMBTileModuleProvider;
...
public class OsmMBTileProvider extends MapTileProviderArray {
    ...
    public OsmMBTileProvider(IRegisterReceiver receiverRegistrar, File file) {
         ...
         */
        super(org.samarthya.collect.android.geo.OsmMBTileSource.createFromFile(file), receiverRegistrar);
