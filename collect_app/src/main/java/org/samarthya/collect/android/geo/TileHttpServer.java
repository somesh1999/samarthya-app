...
import org.samarthya.collect.android.geo.TileSource;
...
class TileHttpServer {
    ...
    private final Map<String, org.samarthya.collect.android.geo.TileSource> sources = new HashMap<>();
     ...
     */
    public void addSource(String key, org.samarthya.collect.android.geo.TileSource source) {
    ...
    public void destroy() {
        ...
        server.interrupt();
        for (org.samarthya.collect.android.geo.TileSource source : sources.values()) {
            ...
            if (request.startsWith("GET /")) {
                ...
                if (parts.length == 4) {
                    try {
                        ...
                        org.samarthya.collect.android.geo.TileSource source = sources.get(key);
                        if (source != null) {
