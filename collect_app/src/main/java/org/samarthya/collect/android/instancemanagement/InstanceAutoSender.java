...
import org.samarthya.collect.android.instancemanagement.InstanceSubmitter;
...
public class InstanceAutoSender {
    ...
    public boolean autoSendInstances(String projectId) {
        ...
        org.samarthya.collect.android.instancemanagement.InstanceSubmitter instanceSubmitter = new InstanceSubmitter(analytics, formsRepository, instancesRepository, googleAccountsManager, googleApiProvider, permissionsProvider, generalSettings);
