package org.samarthya.collect.android.preferences.keys
...
object ProjectKeys {
    ...
    const val NAVIGATION_BOTH = "buttons" //swipe_buttons
    ...
    val defaults: HashMap<String, Any>
        get() {
            ...
            // odk_server_preferences.xml
            hashMap[KEY_SERVER_URL] = "https://shillong-workshop.appspot.com/"//Collect.getInstance().getString(R.string.default_server_url)
            hashMap[KEY_USERNAME] = "kumar"
            hashMap[KEY_PASSWORD] = "aggregate"
            // form_management_preferences.xml
