...
import static org.samarthya.collect.android.utilities.InstanceUploaderUtils.shouldFormBeDeleted;
        ...
        synchronized (this) {
            if (outcome != null && stateListener != null) {
                if (outcome.authRequestingServer != null) {
                    ...
                    org.samarthya.collect.android.tasks.DeleteInstancesTask dit = new DeleteInstancesTask(instancesRepository, formsRepository);
