...
public class ImageConverter {
    ...
    private static void scaleDownImage(String imagePath, int maxPixels) {
        Bitmap image = org.samarthya.collect.android.utilities.FileUtils.getBitmap(imagePath, new BitmapFactory.Options());
        ...
        if (image != null) {
            ...
            if (originalWidth > originalHeight && originalWidth > maxPixels) {
                ...
                org.samarthya.collect.android.utilities.FileUtils.saveBitmapToFile(image, imagePath);
