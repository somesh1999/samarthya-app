...
import org.samarthya.collect.android.utilities.ContentUriProvider;
...
import static org.samarthya.collect.android.utilities.FileUtils.deleteAndReport;
...
public class MediaUtils {
    ...
    public void openFile(Context context, File file, String mimeType) {
        ...
        if (mimeType == null || mimeType.isEmpty()) {
            mimeType = org.samarthya.collect.android.utilities.FileUtils.getMimeType(file);
        }
        intent.setDataAndType(contentUri, mimeType);
        org.samarthya.collect.android.utilities.FileUtils.grantFileReadPermissions(intent, contentUri, context);
    ...
    public boolean isVideoFile(File file) {
        return org.samarthya.collect.android.utilities.FileUtils.getMimeType(file).startsWith("video");
    }

    public boolean isImageFile(File file) {
        return org.samarthya.collect.android.utilities.FileUtils.getMimeType(file).startsWith("image");
    }
