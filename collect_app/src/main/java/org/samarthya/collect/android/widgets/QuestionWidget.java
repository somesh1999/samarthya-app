...
import org.samarthya.collect.android.utilities.AnimationUtils;
...
import org.samarthya.collect.android.utilities.ViewUtils;
import org.samarthya.collect.android.widgets.interfaces.Widget;
import org.samarthya.collect.android.widgets.items.SelectImageMapWidget;
...
import static org.samarthya.collect.android.analytics.AnalyticsEvents.PROMPT;
import static org.samarthya.collect.android.formentry.media.FormMediaUtils.getClipID;
import static org.samarthya.collect.android.formentry.media.FormMediaUtils.getPlayColor;
import static org.samarthya.collect.android.formentry.media.FormMediaUtils.getPlayableAudioURI;
...
public abstract class QuestionWidget extends FrameLayout implements Widget {
     ...
     * {@link org.samarthya.collect.android.utilities.QuestionMediaManager} to access media attached
     * to the instance.
     */
    @Nullable
    @Deprecated
